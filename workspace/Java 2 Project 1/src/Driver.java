...
public class Driver {
	...
	public static void main(String[] args) {
		...
		rest.entarray[7] = new Entrée("Garlic, Ash Yam, and Horker meat mixed into a hardy stew",
		...
		System.out.println("Average price of an entrée\n$" + rest.avgPrice());
